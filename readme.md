...
- En esta practica de VR el usuario podrá obtener el poder de la UI para destruir los peones del ajedrez. Podrá obtener información de las piezas y hacer temblar a los alfiles si se mira a la reina.


![Alt Text](Img/img-demo.gif)